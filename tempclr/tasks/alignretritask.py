...
class AlignRetriTask(VideoRetriTask):
    ...
    def temporal_alignment(
        self, pooled_video, pooled_text, text_start, text_end, video_start, video_end
    ):
        ...
        seq_lengths, filtered_video_count = self.sequence_length(
            indices_list, threshold
        )
    ...
    def generate_alignment_keys(
        pooled_video, pooled_text, indices, seq_length, threshold, total_sample_size
    ):
