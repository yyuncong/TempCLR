...
from tempclr.utils import recursive_config
...
class LocalJob(BaseJob):
    ...
    CMD_CONFIG = {
        "local_single": [
            "fairseq-train", "[yaml]", "--user-dir", "tempclr",
        ...
        "local_predict": ["python", "tempclr_cli/predict.py", "[yaml]"],
    }
    ...
    def submit(self):
        ...
        if "predict" not in self.job_type:
            # append fairseq args.
            from tempclr.utils import load_config
